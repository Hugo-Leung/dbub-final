...
\begin{letter}{Physical Review Letters}
	...
	\begin{itemize}
		%\item Prof.~Barbara Badelek, University of Warsaw (\href{mailto:badelek@fuw.edu.pl}{badelek@fuw.edu.pl} %suggestion from Dave Gaskell
		%\item Dr.~Peter Bosted, College of William \& Mary (\href{mailto:bosted@jlab.org}{bosted@jlab.org}) %suggestion from Dave Gaskell
