...
\begin{figure}[htpb!]
	...
	\caption{The extracted $\bar{d}/\bar{u}$ (top) and $\bar{d}-\bar{u}$ (bottom)
		...
		from SeaQuest (red solid circles), E866~\cite{towell2001} (open blue circles), and HERMES~\cite{ackerstaff1998} (black triangles).
	...
	\todo{add PDF and model to both figures}
\end{figure}
