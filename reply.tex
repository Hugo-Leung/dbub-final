...
\begin{letter}{Physical Review Letters}
	...
	throughout the paper and to improve clarity.
	...
	\begin{enumerate}
		\item \begin{displayquote}
		      ...
		      However, we do not believe an NNLO extraction would provide any more useful information than the current NLO extraction.
		      ...
		      Therefore, this extraction is not as accurate as a proper global analysis.
		      An NNLO extraction would not be any more informative given these simplifications.
		...
		\item \begin{displayquote}
		      ...
		      We have added a sentence explaining `empty flask' to line~?? in the updated manuscript.
		\item \begin{displayquote}
		...
		\item \begin{displayquote}
		      ...
		      \end{displayquote}
		      We agree that we should have defined the variables $x_1$ and $x_2$ in the original manuscript.
		...
		\item \begin{displayquote}
		      ...
		      Thank you for pointing this out. We had reached out C.~Bourrely, one of the authors of Ref.~?. And he had provided us the error bands for the statistical model prediction on $\bar{d}-\bar{u}$.
		      We have added the error bands to the lower left panel.
		      \todo{Jen-Chieh reached out the C.~Bourrely. He will get back to us.}
	\end{enumerate}
    \begin{displayquote}
