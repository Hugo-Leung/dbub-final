...
\begin{letter}{Physical Review Letters}
    ...
    \begin{enumerate}
        ...
        cross section ratio is related to the parton distributions. 
        This extraction is performed with many simplification,
        and therefore not as accurate as a proper global fit.
        A NNLO extraction would not be any more informative given these simplification.
        PDF global analysis groups should use the measured cross section ratio, which is the main result of this paper,
        ...
        \todo{Replace the key with ``accidental coincidence''?} 
        \item \begin{displayquote}
        ...
        We have added the following a sentence in line~??? in the updated manuscript.
        \todo{Add something like ``An empty flask target is used to measure the background from interactions of the beam with materials other than the target material, and this background is subtracted from the data.''}
        \item \begin{displayquote}
        ...
        We have added the definition to 
    ...
    \end{displayquote}
    We thank Referee B for the positive assessment of this work.
