...
\begin{letter}{Physical Review Letters}
    ...
    \end{displayquote}
    We thank Referee A for the positive assessment of this work.
    ...
    \begin{enumerate}
        ...
        \end{displayquote}
        \todo{Do we have the code to do NNLO? If not, what should we say?}
        \item  \begin{displayquote}
        ...
        \end{displayquote}
        \todo{I have a plot, but we need a better one and some explanation for why the first part changed}}
        \item \begin{displayquote}
